        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            ...
            <p className="text-base md:text-xl text-muted-foreground max-w-3xl mx-auto mb-6 md:mb-8 px-4">
              ...
              Изучайте, тестируйте и совершенствуйте навыки работы с веб-приложениями.
            </p>
          </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Определяйте селекторы для Selenium, изучайте API endpoints для автотестов, 
        ...
        <div className="text-center mb-16">
          <div className="max-w-2xl mx-auto px-4">
            ...
            <p className="text-muted-foreground mb-8">
              ...
              Каждый раздел содержит практические упражнения и подсказки.
            </p>
